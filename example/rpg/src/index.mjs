...
async function main(port) {
    ...
    // Generate base OpenAPI information from package.json (title, description and version).
    const info = JSON.parse(await fsp.readFile('package.json'));
    await crs.defineOpenApiFromPackage(info);
